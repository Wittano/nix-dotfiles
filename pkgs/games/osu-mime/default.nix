# THIS PACKAGE IS COPYING FROM nix-gaming REPOSITORY (see: https://github.com/fufexan/nix-gaming/blob/master/pkgs/osu-mime/default.nix)
# I did it, becauses I need this package from for this patched osu!lazer
{ lib
, stdenvNoCC
, fetchurl
, librsvg
